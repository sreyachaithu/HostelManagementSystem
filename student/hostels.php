...
<div class="container">
    <div class="card-deck cards-format ">
      <div class="card border-secondary">
        <img class="card-img-top" src="assets/images/a.jpg" alt="Card image cap">
        <div class="card-body">
      ...
      <div class="card border-secondary">
        <img class="card-img-top card-image" src="assets/images/3.png" alt="Card image cap">
        <div class="card-body">
      ...
      <div class="card border-secondary">
        <img class="card-img-top card-image" src="assets/images/cover4.jpg" alt="Card image cap">
        <div class="card-body">
...
<div class="container second-card">
    <div class="card-deck cards-format">
      <div class="card border-secondary">
        <img class="card-img-top" src="assets/images/A.jpeg" alt="Card image cap">
        <div class="card-body">
      ...
      <div class="card border-secondary">
        <img class="card-img-top" src="assets/images/cover3.jpg" alt="Card image cap">
        <div class="card-body">
      ...
      <div class="card border-secondary">
        <img class="card-img-top" src="assets/images/e.jpg" alt="Card image cap">
        <div class="card-body">
